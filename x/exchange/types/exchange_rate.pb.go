...
// source: buchain/exchange/exchange_rate.proto
...
func (*ExchangeRate) Descriptor() ([]byte, []int) {
	return fileDescriptor_3c08b9086ddbeded, []int{0}
}
...
func init() {
	proto.RegisterFile("buchain/exchange/exchange_rate.proto", fileDescriptor_3c08b9086ddbeded)
}

var fileDescriptor_3c08b9086ddbeded = []byte{
	// 167 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *ExchangeRate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintExchangeRate(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Rate) > 0 {
		i -= len(m.Rate)
		copy(dAtA[i:], m.Rate)
		i = encodeVarintExchangeRate(dAtA, i, uint64(len(m.Rate)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Index) > 0 {
		i -= len(m.Index)
		copy(dAtA[i:], m.Index)
		i = encodeVarintExchangeRate(dAtA, i, uint64(len(m.Index)))
		i--
		dAtA[i] = 0xa
	}
