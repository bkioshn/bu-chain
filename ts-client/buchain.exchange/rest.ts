...
export interface ExchangeExchangeRate {
  index?: string;
  rate?: string;
  creator?: string;
}

export type ExchangeMsgCreateExchangeRateResponse = object;

export type ExchangeMsgDeleteExchangeRateResponse = object;

export type ExchangeMsgExchangeTokenResponse = object;

export type ExchangeMsgUpdateExchangeRateResponse = object;
...
export interface ExchangeQueryAllExchangeRateResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/bu-chain/exchange/exchange_rate
   */
  queryExchangeRateAll = (
    ...
    this.request<ExchangeQueryAllExchangeRateResponse, RpcStatus>({
      path: `/bu-chain/exchange/exchange_rate`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @summary Queries a ExchangeRate by index.
   * @request GET:/bu-chain/exchange/exchange_rate/{index}
   */
  queryExchangeRate = (index: string, params: RequestParams = {}) =>
    this.request<ExchangeQueryGetExchangeRateResponse, RpcStatus>({
      path: `/bu-chain/exchange/exchange_rate/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/bu-chain/exchange/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ExchangeQueryParamsResponse, RpcStatus>({
      path: `/bu-chain/exchange/params`,
      method: "GET",
      format: "json",
      ...params,
    });
